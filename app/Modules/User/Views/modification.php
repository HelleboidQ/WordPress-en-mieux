<div class="container">
    ...
    <form method='post' action="<?php /*echo DIR;*/ ?>utilisateur/modification">
        ...
        <input class="form-control" type='password' name="current_password"
               placeholder="Votre mot de passe courant" required/><br/>
        <label>Mot de passe</label>
        <input class="form-control" type='password' name="password"
               placeholder="Votre nouveau mot de passe" required/><br/>
        <label>Mot de passe</label>
        <input class="form-control" type='password' name="password-again"
               placeholder="Votre nouveau mot de passe" required/><br/>
